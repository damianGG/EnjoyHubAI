...
import type { Slot, Offer } from "@/lib/types/dynamic-fields"

interface BookingWidgetDemoProps {
  offer: Offer
}
...
function generateMockSlots(): Slot[] {
  return [
    { startTime: "10:00", endTime: "11:00", available: true, capacityLeft: 2 },
    { startTime: "11:00", endTime: "12:00", available: true, capacityLeft: 1 },
    { startTime: "12:00", endTime: "13:00", available: false, capacityLeft: 0 },
    { startTime: "14:00", endTime: "15:00", available: true, capacityLeft: 3 },
    { startTime: "15:00", endTime: "16:00", available: true, capacityLeft: 2 },
    { startTime: "16:00", endTime: "17:00", available: false, capacityLeft: 0 },
    { startTime: "17:00", endTime: "18:00", available: true, capacityLeft: 1 },
    { startTime: "18:00", endTime: "19:00", available: true, capacityLeft: 2 },
  ]
}
...
export default function BookingWidgetDemo({ offer }: BookingWidgetDemoProps) {
  ...
  // Handle booking submission (demo mode - simulate success)
