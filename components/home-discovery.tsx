                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="grid grid-cols-2 gap-4">
                    {heroCategories.map((category) => (
                      <div key={category.label} className={`w-36 rounded-[24px] border border-black/[0.055] bg-white p-4 text-center shadow-[0_15px_32px_rgba(61,39,17,0.10)] ${category.transform}`}>
                        <div className="mx-auto grid h-16 w-16 place-items-center rounded-[20px] bg-gradient-to-br from-orange-50 to-amber-50 text-4xl shadow-inner">{category.icon}</div>
