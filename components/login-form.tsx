...
export default function LoginForm({
  ...
  const forgotPasswordHref = `/auth/forgot-password?next=${encodeURIComponent(destination)}`
      ...
      <form action={formAction} className="space-y-4">
        ...
        {onSwitchToPhoneLogin && (
          <div className="pt-2 text-center text-sm text-muted-foreground">
            <button type="button" onClick={onSwitchToPhoneLogin} className="text-primary hover:underline">
