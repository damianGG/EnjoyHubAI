...
assert.match(searchDialog, /bbox: usingCurrentLocation && currentLocationBbox/)
...
assert.match(currentLocation, /CURRENT_LOCATION_RADIUS_KM = 30/)
assert.match(currentLocation, /api\.maptiler\.com\/geocoding/)
