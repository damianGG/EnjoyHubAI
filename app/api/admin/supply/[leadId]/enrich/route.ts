        ...
        input: [
          {
            ...
            content: [
              ...
              "Jeżeli atrybut typu select ma listę options, zwróć dokładnie jedną wartość z tej listy. Nie tłumacz i nie zmieniaj wartości technicznej.",
              "Dla pól boolean zwracaj boolean_value=true/false tylko wtedy, gdy źródło pozwala to wiarygodnie ustalić; brak informacji nie oznacza false.",
